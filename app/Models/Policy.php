...
class Policy extends Model {
     ...
     * @var array
     */
    protected $fillable = ['beneficiaries', 'expiry', 'payer', 'premium', 'ref_no', 'renewal', 'special_remarks', 'type', 'nr_inmat'];
    ...
    public function nr_inmat() {
        return $this->belongsTo(OcrData::class, 'nr_inmat');
    }
