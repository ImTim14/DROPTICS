...
class PolicyController extends Controller {
    ...
    */
    ...
    public function add(Request $request) {
        ...
        $nr_inmat = $request->nr_inmat;
//        $ss = $request->ss;
        
        foreach($request->owners as $owner) {
            $client = $company->clients()->find($owner);
            $policy = new Policy($request->only(array('beneficiaries', 'expiry', 'payer', 'renewal', 'type', 'nr_inmat', 'ss')));
            ...
            $policy->nr_inmat()->associate($nr_inmat);
//            $policy->ss()->associate($ss);
            $policy->save();
    ...
    public function edit(Request $request, Policy $policy) {
        ...
        $policy->nr_inmat           = $request->nr_inmat ?: null;
        $policy->ss                 = $request->ss ?: null;
    ...
    public function getAll(Request $request) {
        ...
        switch($user->role) {
            ...
            case 'staff':
                ...
                $view_data['nr_inmat'] = OCRData::all();
                $view_data['ss'] = OCRData::all();
                break;
            case 'broker':
    ...
    public function getOne(Request $request, Policy $policy) {
        ...
        $policy->nr_inmat_string = OcrData::with("policies")->where('id', $policy->nr_inmat)->get()->first()->nr_inmat;
        $policy->ss_string = OcrData::with("policies")->where('id', $policy->nr_inmat)->get()->first()->ss;
