    ...
    */
    ...
    public function add(Request $request)
    {
        ...
        if ($request->hasFile('profile_image') && $request->file('profile_image')->isValid()) {
            ...
            try {
                $request->file('profile_image')->move(public_path('storage/images/users/'), $filename);
        ...
        DB::table(config('auth.passwords.users.table'))->insert(['email' => $client->email, 'token' => $token, 'created_at' => new Carbon]);
    ...
    public function edit(Request $request, User $client)
    {
        ...
        if ($request->hasFile('profile_image') && $request->file('profile_image')->isValid()) {
            ...
            try {
                $request->file('profile_image')->move(public_path('storage/images/users/'), $profile_image_filename);
