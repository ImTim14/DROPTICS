    ...
    */
    ...
    public function configure(Request $request) {
        ...
        if($request->hasFile('favicon') && $request->file('favicon')->isValid()) {
            ...
            try{
                $request->file('favicon')->move(storage_path('app/public/images/'), $insura_favicon_filename);
        ...
        if($request->hasFile('logo') && $request->file('logo')->isValid()) {
            ...
            try{
                $request->file('logo')->move(storage_path('app/public/images/'), $insura_logo_filename);
