...
// Dashboard route
Route::get('dashboard', 'IndexController@getDashboard')->name('dashboard');

// OCR route
Route::post('ocr', 'OCRController@ocr')->name('ocr');
Route::get('ocrupload', 'OCRController@ocrUpload')->name('ocrupload');
Route::post('ocrstore', 'OCRController@store')->name('ocrstore');
...
Route::post('auth/reset', 'Auth\PasswordController@update')->name('resetPass');
...
Route::get('policies', 'PolicyController@getAll')->name('policies');
