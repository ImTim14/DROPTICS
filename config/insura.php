...
return [
    ...
    'currencies'    => [
        'default'   => env('INSURA_CURRENCY_DEFAULT', 'USD'),
        'list'      => [
            [
                "symbol" => 'AED',
    ...
    'favicon'       => env('INSURA_FAVICON', 'favicon.png'),
    'languages'     => [
        [
            'identifiers'   => ['en_US.UTF-8', 'en.UTF-8', 'en-US', 'en'],
            'locale'        => 'en_US',
            'name'          => 'English (US)'
        ]
    ],
    'logo'          => env('INSURA_LOGO', 'logo.png'),
    'name'          => env('INSURA_NAME', 'Droptics'),
