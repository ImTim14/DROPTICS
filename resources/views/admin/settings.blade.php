...
{{--                                                <option{{ (null != old('reminders') && old('reminders')['1']['type'] === 'email' ) || empty(old('reminders')) ? ' selected' : '' }} value="email">{{ trans('settings.input.option.email') }} </option>--}}
{{--                                                <option{{ (null != old('reminders') && old('reminders')['1']['type'] === 'text') ? ' selected' : '' }} value="text">{{ trans('settings.input.option.text') }}</option>--}}
{{--                                            </select>--}}
{{--                                        </div>--}}
{{--                                        <div class="field required">--}}
{{--                                            <label>{{ trans('settings.input.label.subject') }}</label>--}}
{{--                                            <input type="text" name="reminders[1][subject]" placeholder="{{ trans('settings.input.placeholder.subject') }}" required value="{{ old('reminders')['1']['subject'] ?? null }}"/>--}}
{{--                                        </div>--}}
{{--                                        <div class="two fields">--}}
{{--                                            <div class="field required">--}}
{{--                                                <label>{{ trans('settings.input.label.timeline') }}</label>--}}
{{--                                                <select class="ui fluid search dropdown" name="reminders[1][timeline]">--}}
{{--                                                    <option{{ (null != old('reminders') && old('reminders')['1']['timeline'] === 'after') || empty(old('reminders')) ? ' selected' : '' }} value="after">{{ trans('settings.input.option.after_expiry') }} </option>--}}
{{--                                                    <option{{ (null != old('reminders') && old('reminders')['1']['timeline'] === 'before') ? ' selected' : '' }} value="before">{{ trans('settings.input.option.before_expiry') }}</option>--}}
{{--                                                </select>--}}
{{--                                            </div>--}}
{{--                                            <div class="field">--}}
{{--                                                <label>{{ trans('settings.input.label.days') }} <span class="timeline"></span></label>--}}
{{--                                                <input type="number" max="365" min="1" name="reminders[1][days]" placeholder="" required step="1" value="{{ old('reminders')['1']['days'] ?? null }}" />--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="field">--}}
{{--                                            <label>{{ trans('settings.input.label.message') }}</label>--}}
{{--                                            <textarea rows="9" name="reminders[1][message]" placeholder="{{ trans('settings.input.placeholder.message') }}" required>{{ old('reminders')['1']['message'] ?? null }}</textarea>--}}
{{--                                        </div>--}}
{{--                                    </p>--}}
{{--                                </div>--}}
{{--                                @endforelse--}}
