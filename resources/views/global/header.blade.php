            ...
            <div class="ui left floated segment header-avatar">
                <div class="ui very relaxed horizontal list">
                    <div class="ui item top-avatar top right pointing icon dropdown">
                        <img class="ui avatar image" src="{{ asset('storage/images/users/' . $user->profile_image_filename) }}">
        ...
        <div class="small-monitor">
            ...
            <div class="branding">
                <a href="{{ action('IndexController@getDashboard') }}">
                    <img src="{{ asset('storage/images/' . config('insura.logo')) }}" class="ui image">
                </a>
            </div>
            <div class="branding-icon">
                <a href="{{ action('IndexController@getDashboard') }}">
                    <img src="{{ asset('storage/images/' . config('insura.favicon')) }}" class="ui image">
                </a>
            </div>
        </div>
    </header>