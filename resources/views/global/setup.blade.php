...
<head>
    ...
    <title>{{ trans('setup.title') }} - {{ config('insura.name') }} | Sistem de gestiune online pentru asigurări</title>
    <base href="{{ env('BASE_HREF', '') }}" />
    <!-- Favicon -->
    <link href="{{ asset('favicon.ico') }}" rel="icon" sizes="16x16" type="image/x-icon">
    <link href="{{ asset('storage/images/' . config('insura.favicon')) }}" rel="icon" type="{{ mime_content_type(storage_path() . '/app/images/' . config('insura.favicon')) }}">
    <!-- Font and Icon Fonts -->
...
<div class="container">
    <div class="page-title with-desc">
        <img alt="Logo" src="{{ asset('storage/images/' . config('insura.favicon')) }}" /><br/>
                ...
                <div class="col-xs-8 col-xs-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="ui form">
                        ...
                        <div class="field">
                            ...
                            <input type="file" accept="image/*" class="file-upload" data-allowed-file-extensions="bmp gif jpeg jpg png svg" data-allowed-formats="landscape" data-default-file="{{ asset('storage/images/' . config('insura.logo')) }}" name="logo"/>
                        </div>
                        <div class="field">
                            <label>{{ trans('setup.input.label.favicon') }}</label>
                            <input type="file" accept="image/*" class="file-upload" data-allowed-file-extensions="bmp gif jpeg jpg png svg" data-allowed-formats="square" data-default-file="{{ asset('storage/images/' . config('insura.favicon')) }}" name="favicon">
                        </div>
                        <div class="divider"></div>
                        <div class="field">
                ...
                <div class="col-xs-8 col-xs-offset-2 col-md-6 col-md-offset-3">
                    ...
                    <div class="ui form">
                        ...
                        <div class="field">
                            ...
                            <input type="file"  accept="image/*" class="file-upload" data-allowed-file-extensions="bmp gif jpeg jpg png svg" data-default-file="{{ asset('storage/images/users/default-profile.jpg') }}" name="profile_image">
                        </div>
                        <div class="divider"></div>
                        <div class="field">
