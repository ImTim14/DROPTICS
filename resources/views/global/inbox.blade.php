...
<head>
    ...
    <title>{{ trans('inbox.title') }} - {{ config('insura.name') }} | Sistem de gestiune online pentru asigurări</title>
            ...
            <div class="ui fluid selection search dropdown">
                ...
                <div class="menu">
                    ...
                    <div class="item" data-value="{{ $contact->id }}">
                        <img class="ui mini avatar image" src="{{ asset('storage/images/users/' . $contact->profile_image_filename) }}">
                        {{ $contact->fullName }}
                    </div>
                    @empty
        ...
        <div class="people-list">
            <ul class="people">
                ...
                <li class="person" data-person="{{ $contact->id }}"{!! in_array($contact->id, $chatees->all()) ? '' : ' style="display:none;"' !!}>
                    <img src="{{ asset('storage/images/users/' . $contact->profile_image_filename) }}" alt="{{ $contact->first_name }}'s Profile Photo" />
                    <span class="name">
                        {{ $contact->fullName }}
                    ...
                    <span class="preview text-ellipsis" data-message="{{ $contact->chats?->last()?->id ?? '' }}">{{ $contact->chats?->last()?->message ?? '' }}</span>
                    <span class="status" data-message="{{ $contact->chats?->last()->id ?? '' }}">
