...
@section('profile_bar')
        ...
        <div class="ui segment white right-bar-profile right-bar-profile-bottom">
            <div class="user-profile m-b-15">
                ...
                @else
                <img src="{{ asset('storage/images/users/' . $policy->client->profile_image_filename) }}" alt="{{ $policy->client->first_name . ' ' . $policy->client->last_name }}"/>
                @endif
            ...
            <div class="ui segment white fs-16">
                ...
                <div class="policy-details">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <span>{{ trans('policies.label.nr_inmat') }}</span>
                            <p>{{ $policy->nr_inmat_string }}</p>
                        </div>
                        <div class="col-md-3">
                            <span>{{ trans('policies.input.label.ss') }}</span>
                            <p>{{ $policy->ss_string }}</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
